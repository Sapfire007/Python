...
async def function1():
  ...
  open("Day081/target/picture.jpg", "wb").write(response.content)
...
async def function2():
  ...
  response = requests.get(URL)
  open("Day081/target/picture2.jpg", "wb").write(response.content)

async def function3():
  print("func 3")
  URL = "https://c4.wallpaperflare.com/wallpaper/622/676/943/3d-hd-wikipedia-3d-wallpaper-preview.jpg"
  response = requests.get(URL)
  open("Day081/target/picture3.jpg", "wb").write(response.content)
