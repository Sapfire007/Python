...
def download_file(url, local_filename): 
  ...
  with requests.get(url, stream=True) as r:
      r.raise_for_status()
      with open(local_filename, 'wb') as f:   #The 'wb' part means it’s opened for writing binary data (like saving a picture).
...
"""
Console to be run in shell/terminal : python ./Day072/main.py https://jooinn.com/images/nature-319.jpg -o Day072/Natur
e.jpg
"""
